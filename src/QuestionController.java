...
public class QuestionController {
    ...
    public String addQuestion(String jsonBody) throws SQLException {
        ...
        String sql = "INSERT INTO questions (question_text, option_a, option_b, option_c, option_d, correct_answer, teacher_id) " +
                     "VALUES (?, ?, ?, ?, ?, ?, ?) RETURNING id";
        ...
        try (Connection conn = DatabaseManager.getConnection();
            ...
            pstmt.setInt(7, question.getTeacherId());
    ...
    public String submitQuiz(String jsonBody) throws SQLException {
        int studentId = Integer.parseInt(extractValue(jsonBody, "studentId"));
        ...
        String sql = "INSERT INTO student_scores (student_id, score, total_questions) VALUES (?, ?, ?)";
        try (Connection conn = DatabaseManager.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(sql)) {
    ...
    public String getScoreboard() throws SQLException {
        ...
        String sql = "SELECT ss.id, ss.student_id, u.username, ss.score, ss.total_questions, ss.completed_at " +
    ...
    private Question parseQuestionFromJson(String json) {
        ...
        q.setTeacherId(Integer.parseInt(extractValue(json, "teacherId")));
        return q;
    }
